function generate_actions() {
	var list_events = [ "--Select--", "Mouse", "Keyboard", "Browser",
		"JavaScript", "Screenshot", "Validate", "Database", "Window",
		"Tab", "Alert", "WebService", "Wait", "Dropdown_Select" ];
	var select = [ "--Select--" ];
	...
	div_ch.appendChild(document.createTextNode('Count'));
	div_ch
	.appendChild(document
			.createTextNode('\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0'));
...
function create_webelement(previous, size, data) {
	...
	var selectors = [ "--Select--", "id", "xpath", "Css", "name", "Tag",
		"LinkText", "PartialLinkText", "ClassName" ];
...
function process_data(data, data2) {
	...
	var Mouse = [ "--Select--", "click", "DodubleClick", "ClickandHold",
		"ContextClick", "DragDrop", "Hover", "Submit" ];
	var Keyboard = [ "--Select--", "write_text" ];
	var Browser = [ "--Select--", "GotoURL", "Maximize", "Refresh", "Close" ];
	var JavaScript = [ "--Select--", "Click", "EnterData", "DodubleClick",
		"ClickandHold", "ContextClick", "DragDrop", "Hover" ];
